      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8 text-center md:text-left">
          <div className="max-w-2xl mx-auto md:mx-0">
            ...
            <h2 className="text-4xl md:text-5xl font-headline">Meet Our Elite Trainers</h2>
          ...
          {TRAINERS.map((trainer, idx) => (
            <Card key={idx} className="border-none shadow-none overflow-hidden bg-white group">
              <CardContent className="p-0">
                <div className="relative aspect-[4/5] rounded-[3rem] bg-secondary/20 border-2 border-dashed border-primary/10 flex flex-col items-center justify-center mb-6 transition-all duration-500 group-hover:bg-primary/5 group-hover:border-primary/30">
                  <div className="flex flex-col items-center gap-4 text-primary/30 group-hover:text-primary transition-colors">
                    <div className="relative">
                      <User className="w-16 h-16" />
                      <Clock className="absolute -bottom-2 -right-2 w-6 h-6" />
                    </div>
                    <span className="font-headline font-bold uppercase tracking-widest text-sm">Profile Coming Soon</span>
                  </div>
                </div>
                <div className="text-center">
