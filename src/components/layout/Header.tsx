...
export function Header() {
  ...
  // ✅ FIX: safe navigation (prevents glitch)
  ...
  return (
    <>
      ...
      {/* ✅ FIX: MOBILE MENU OUTSIDE HEADER */}
      <div
        className={cn(
          "lg:hidden fixed inset-0 bg-background z-40 flex flex-col items-center justify-center transition-transform duration-500 ease-in-out",
      ...
      >
        <div className="flex flex-col items-center gap-8 w-full px-6">
          ...
          <div className="flex flex-col gap-4 w-full max-w-sm pt-12">
            ...
            <Button
              variant="outline"
              className="gap-3 h-16 text-xl font-bold rounded-3xl border-2"
            >
